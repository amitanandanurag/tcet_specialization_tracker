...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2026 at 04:59 PM
...
INSERT INTO `st_student_master` (`student_id`, `academic_year`, `registration_no`, `joining_date`, `class_id`, `division_id`, `batch_id`, `roll_no`, `department_id`, `specialization_id`, `specialization_subject_id`, `cgpa`, `fname`, `mname`, `lname`, `dob`, `gender`, `nationality`, `apaar_id`, `uan`, `pan`, `permanent_address`, `present_address`, `city`, `pincode`, `country`, `state`, `phone`, `mobile`, `email`, `photo`, `mark_list`, `birth_certificate`, `transfer_certificate`, `caste_certificate`, `migration_certificate`, `affidavit`, `status`, `created_at`) VALUES
...
(3, 'ashu', 'asdf@gmail.com', '234', 2, 2, 0);
...
--
ALTER TABLE `st_menu_allocation_master`
  MODIFY `menu_allocation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;
