...
--
-- Indexes for table `st_students`
--
ALTER TABLE `st_students`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `st_students`
--
ALTER TABLE `st_students`
...
--
ALTER TABLE `st_student_master`
  MODIFY `student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=636;
