        ...
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-lg-3 col-xs-6">
                <div class="small-box bg-yellow">
                    ...
                    <a href="<?php echo $current_branch_name !== '' ? 'branch_info.php?department_id=' . intval($logged_dept_id) : 'list.php?type=branches'; ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
