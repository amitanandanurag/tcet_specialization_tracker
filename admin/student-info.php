              ...
              <table id="myTable" class="text-center table table-striped table-bordered" width="100%">
                <thead>
                  <tr>
                    ...
                    <th style="background-color: #423cbc; color: white; padding: 16px">Photo</th>
                    ...
                    <th style="background-color: #423cbc; color: white; padding: 16px">section</th>
                    ...
                    <th style="background-color: #423cbc; color: white; padding: 16px">Joining Date</th>
                    <th style="background-color: #423cbc; color: white; padding: 16px">DOB</th>
                    <th style="background-color: #423cbc; color: white; padding: 16px">Gender</th>
                    <th style="background-color: #423cbc; color: white; padding: 16px">Email</th>
                    <th style="background-color: #423cbc; color: white; padding: 16px">City</th>
                    <th style="background-color: #423cbc; color: white; padding: 16px">Address</th>
                    <!-- <th style="background-color: #F97161">Option</th>-->
